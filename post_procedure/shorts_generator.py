...
3. block3 — самый сильный/контринтуитивный пункт + короткий вопрос («а у тебя что в уходе после процедуры?»). Вопрос провоцирует комментарии.
4. CTA — НЕ задавай вопрос (он в block3), не «подписывайся». Только короткая передача КОНКРЕТНОГО магнита: «Полный список ингредиентов — в Telegram @posleprocedur» или «Список привычек одним сообщением — в закрепе @posleprocedur».
...
Верни ТОЛЬКО валидный JSON без пояснений:
{
  ...
  "block3": "1 предложение — самый сильный/контринтуитивный пункт + короткий вопрос",
